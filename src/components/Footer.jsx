        ...
        <div className="footer-top-grid">
          <div className="footer-col brand-col">
            ...
            <div className="social-icons" style={{ display: 'flex', justifyContent: 'center', gap: '1.2rem', marginTop: '1.5rem' }}>
              <a href="https://www.instagram.com/samperfumeseg?igsh=ZWJ6YXUzbmNpZDE1" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Instagram">
              ...
              <a href="https://www.tiktok.com/@samperfumeseg?_r=1&_t=ZS-95cjjsWLGcx" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="TikTok">
