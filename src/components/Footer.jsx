        ...
        <div className="footer-top-grid">
          <div className="footer-col brand-col">
            ...
            <div className="social-icons" style={{ display: 'flex', justifyContent: 'center', gap: '1.2rem', marginTop: '1.5rem' }}>
              <a href="https://www.instagram.com/samperfumesegy?igsh=ZW5zcTdhbm5xYWN6&utm_source=qr" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/share/185BwVbioZ/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="Facebook">
              ...
              <a href="https://www.tiktok.com/@samperfumesegy?_r=1&_t=ZS-96gvtYT4NfD" target="_blank" rel="noopener noreferrer" className="social-icon" aria-label="TikTok">
