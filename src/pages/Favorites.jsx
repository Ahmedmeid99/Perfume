  ...
  return (
    <div className="favorites-page-wrapper">
      <div className="container">
        ...
        <div className="fav-header-nav animate-view reveal active">
        ...
        {/* Page Title */}
        <div className="fav-page-title animate-view reveal active">
        ...
        {loading ? (
          <div className="fav-loader">
            ...
            <p>{lang === 'en' ? 'Loading favorites...' : 'جاري تحميل المفضلة...'}</p>
          </div>
